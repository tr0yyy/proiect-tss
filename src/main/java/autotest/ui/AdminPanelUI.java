...
public class AdminPanelUI {
    ...
    public By adminRoleButton = By.xpath("//app-admin-panel//div//input[contains(@id,'btncheck1')]");
    public By modRoleButton = By.xpath("//app-admin-panel//div//input[contains(@id,'btncheck2')]");
    public By userRoleButton = By.xpath("//app-admin-panel//div//input[contains(@id,'btncheck3')]");
